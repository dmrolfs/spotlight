  ...
  "IsQuorm" should {
    "AtLeastQuorum" should {
      "at least: answer given empty results" in { f: Fixture ⇒
        ...
        fn0( Map.empty[String, Outliers] ) mustBe true
        fn1( Map.empty[String, Outliers] ) mustBe false
        fn2( Map.empty[String, Outliers] ) mustBe false
        fn3( Map.empty[String, Outliers] ) mustBe false
      }
    ...
    "MajorityQuorum" should {
      "majority: answer given empty results" in { f: Fixture ⇒
        ...
        fn0( Map.empty[String, Outliers] ) mustBe false
        fn1( Map.empty[String, Outliers] ) mustBe false
        fn2( Map.empty[String, Outliers] ) mustBe false
        fn3( Map.empty[String, Outliers] ) mustBe false
      }
