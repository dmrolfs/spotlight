...
import lineup.model.timeseries.TimeSeriesCohort.TimeFrame
...
with TryValues {
  ...
  class TestFixture { outer =>
    ...
    def generateTimeSequence( name: String, ys: Seq[Double], unit: Long = 1000L, origin: joda.DateTime = joda.DateTime.now ): Row[DataPoint] = trace.block( s"generateTimeSequence($name, $origin)" ) {
    ...
    def massage( series: Row[DataPoint], frames: Stream[TimeFrame] ): Row[DataPoint] = {
      def frameIndex: joda.DateTime => Int = {
        val intervals = frames map { _.bounds }
        ( pt: joda.DateTime ) => { intervals indexWhere { _.contains( pt ) } }
      }

      def groupByFrame( ser: Row[DataPoint] ): Row[Row[DataPoint]] = {
        @tailrec def loop( data: List[DataPoint], fr: List[TimeFrame], acc: Row[Row[DataPoint]] ): Row[Row[DataPoint]] = {
...
//      trace( s"""FRAMES:[\n${frames.map(f => (f._1.getMillis, f._2.getMillis, f._3.getMillis)).mkString("\n")}\n]""")
    ...
    def compareApproximateCohorts(
      ...
      expected: Row[Row[(joda.DateTime, Double)]],
      timeEps: Long = 1,
      ...
      val factual: Seq[(joda.DateTime, Double)] = actual.flatten
      val fexpected: Seq[(joda.DateTime, Double)] = expected.flatten
      val together: Seq[((joda.DateTime, Double), (joda.DateTime, Double))] = factual zip fexpected
...
//        println( s"eval index[${ae_i._2}}] (${ae_i._1._1.bounds.getStartMillis}-${ae_i._1._1.bounds.getEndMillis} / ${ae_i._1._1.mid.getMillis}}) ?==? (${ae_i._1._2.bounds.getStartMillis}-${ae_i._1._2.bounds.getEndMillis} / ${ae_i._1._2.mid.getMillis}})" )
    ...
    "convert brief cohort to matrix" taggedAs(WIP) in { f: Fixture =>
      ...
      val expected2 = Row( row(e2(0)), row(e2(1)), row(e2(2)), row(e2(3)) )
...
//      val e4 = massage( series4, step = 2 )
    ...
    "convert off-time 2 cohort to matrix" in { f: Fixture =>
      ...
      val allTimes = Seq( series1, series2, series3, series4 ).flatMap( _.map( _.timestamp ) )
...
object TimeSeriesCohortSpec {
  ...
  val mixedTimeFrameGroups = Row(
    Row( //"2015-10-15T10:45:28.595-07:00"-"2015-10-15T10:45:29.595-07:00"            1444931128595L - 1444931129595L | 1444931129095L
      Row(
    ...
    Row( //"2015-10-15T10:45:29.595-07:00"-"2015-10-15T10:45:30.595-07:00"            1444931129595L - 1444931130595L | 1444931130095L
      Row(
    ...
    Row( //"2015-10-15T10:45:30.595-07:00"-"2015-10-15T10:45:31.595-07:00"            1444931130595L - 1444931131595L | 1444931131095L
      Row(
    ...
    Row( //"2015-10-15T10:45:31.595-07:00"-"2015-10-15T10:45:32.595-07:00"            1444931131595L - 1444931132595L | 1444931132095L
      Row(
    ...
    Row( //"2015-10-15T10:45:32.595-07:00"-"2015-10-15T10:45:33.595-07:00"            1444931132595L - 1444931133595L | 1444931133095L
      Row(
    ...
    Row( //"2015-10-15T10:45:33.595-07:00"-"2015-10-15T10:45:34.595-07:00"            1444931133595L - 1444931134595L | 1444931134095L
      Row(
    ...
    Row( //"2015-10-15T10:45:34.595-07:00"-"2015-10-15T10:45:35.595-07:00"            1444931134595L - 1444931135595L | 1444931135095L
      Row(
    ...
    Row( //"2015-10-15T10:45:35.595-07:00"-"2015-10-15T10:45:36.595-07:00"            1444931135595L - 1444931136595L | 1444931136095L
      Row(
    ...
    Row( //"2015-10-15T10:45:36.595-07:00"-"2015-10-15T10:45:37.595-07:00"            1444931136595L - 1444931137595L | 1444931137095L
      Row(
    ...
    Row( //"2015-10-15T10:45:37.595-07:00"-"2015-10-15T10:45:38.595-07:00"            1444931137595L - 1444931138595L | 1444931138095L
      Row(
    ...
    Row( // "2015-10-15T10:45:38.595-07:00"-"2015-10-15T10:45:39.595-07:00"           1444931138595L - 1444931139595L | 1444931139095L
      Row(
      ),
      Row(
      ),
  ...
  val mixedCohortMatrix: Matrix[(joda.DateTime, Double)] = Row(
    Row( //"2015-10-15T10:45:28.595-07:00"-"2015-10-15T10:45:29.595-07:00"            1444931128595L - 1444931129595L | 1444931129095L
